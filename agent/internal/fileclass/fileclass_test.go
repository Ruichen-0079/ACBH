...
func TestClassifyPath(t *testing.T) {
	tests := []struct {
		...
		{"fabric-server-mc.1.20.1-loader.0.16.7-launcher.1.0.1.jar", ServerPack},
		{"server.jar", ServerPack},
		{"libraries/com/google/guava/guava.jar", ServerPack},
		{".fabric/server/fabric-loader-server.jar", ServerPack},
		{"eula.txt", ServerPack},
		...
		{"backups/world.zip", Ignored},
		{".fabric/processedMods/fabric-api.jar", Ignored},
		{".fabric/remappedJars/minecraft.jar", Ignored},
